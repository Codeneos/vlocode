...
// Keep this metadata aligned with the documented OmniStudio Data Mapper and
// Integration Procedure functions. The runtime may keep legacy helpers for
// compatibility, but only documented functions should be advertised here.
