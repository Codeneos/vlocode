...
| `purgeMatchingDependencies`   | `false` | Controls matching-dependency cleanup: `false`/`none` retains default keyless cleanup, `unmatched` deletes excess matching records and can be limited by `purgeMatchingRecordsFilter`, and `true`/`all` retains the previous force-replacement behavior.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `purgeMatchingRecordsFilter`  | `[]`    | Embedded SObject types included in `unmatched` cleanup. An empty filter considers every embedded child type; otherwise only the listed types are considered. Completely empty collections are not inferred or purged.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
